        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#10122B] tracking-tight leading-tight">
              We think beyond <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2151F5] via-[#7B3FF2] to-[#E5389E]">the wave.</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="pt-4 grid grid-cols-2 gap-4 border-t border-[#E3E6F7]">
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2151F5]" />
                  <span className="text-sm font-bold text-[#10122B]">Hawally Based Studio</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2151F5]" />
                  <span className="text-sm font-bold text-[#10122B]">170+ Delivered Projects</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6">
              <div className="relative rounded-3xl overflow-hidden border border-[#E3E6F7] shadow-soft-lg aspect-[4/3] bg-[#F6F7FF]">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#10122B]/60 via-transparent to-transparent" />
      ...
      <section className="py-24 bg-[#F6F7FF] border-t border-[#E3E6F7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            ...
            <p className="text-sm text-[#4B4F72]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreValues.map((value) => (
              <div
                key={value.title}
                className="bg-white rounded-3xl p-8 border border-[#E3E6F7] shadow-soft hover:shadow-soft-lg hover:border-[#2151F5]/40 transition-all duration-300 space-y-4"
              >
                <div className="w-12 h-12 rounded-2xl bg-[#EAF0FF] text-[#2151F5] flex items-center justify-center">
                  <value.icon className="w-6 h-6" />
                </div>
                <h3 className="font-display text-xl font-bold text-[#10122B]">
                  {value.title}
                </h3>
      ...
      <section className="py-24 bg-white border-t border-[#E3E6F7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Leadership Card 1 */}
            <div className="bg-[#F6F7FF] rounded-3xl p-6 border border-[#E3E6F7] space-y-4 text-center">
              <div className="w-24 h-24 rounded-full bg-[#EAF0FF] text-[#2151F5] font-display font-extrabold text-2xl flex items-center justify-center mx-auto border-2 border-white shadow-md">
                BC
              </div>
              <div>
                <h3 className="font-display text-xl font-bold text-[#10122B]">Creative Director</h3>
                <p className="text-xs font-semibold text-[#2151F5]">Brand & Visual Strategy</p>
              </div>
            ...
            <div className="bg-[#F6F7FF] rounded-3xl p-6 border border-[#E3E6F7] space-y-4 text-center">
              ...
              <div>
                <h3 className="font-display text-xl font-bold text-[#10122B]">Lead Software Architect</h3>
                <p className="text-xs font-semibold text-[#2151F5]">Engineering & ERP Solutions</p>
              </div>
              <p className="text-xs text-[#4B4F72] leading-relaxed">
            ...
            <div className="bg-[#F6F7FF] rounded-3xl p-6 border border-[#E3E6F7] space-y-4 text-center">
              ...
              <div>
                <h3 className="font-display text-xl font-bold text-[#10122B]">Digital Growth Lead</h3>
                <p className="text-xs font-semibold text-[#2151F5]">Performance & SEO Strategy</p>
              </div>
              <p className="text-xs text-[#4B4F72] leading-relaxed">
