...
export default function ContactPage() {
  ...
  return (
    <div className="space-y-0 pt-28">
      ...
      <section className="py-20 bg-gradient-to-b from-[#F6F7FF] via-[#EAF0FF]/30 to-[#F6F7FF] border-b border-[#E3E6F7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl space-y-6">
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#10122B] tracking-tight leading-tight">
            Let’s discuss <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2151F5] via-[#7B3FF2] to-[#E5389E]">your next project.</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-[#F6F7FF] rounded-3xl p-8 border border-[#E3E6F7] space-y-6">
                <h3 className="font-display text-2xl font-bold text-[#10122B]">
                  Hawally Studio
                </h3>

                <div className="space-y-5 text-sm text-[#10122B]">
                  
                  {/* Address */}
                  <div className="flex items-start gap-3.5">
                    <div className="w-10 h-10 rounded-xl bg-[#EAF0FF] text-[#2151F5] flex items-center justify-center shrink-0">
                      <MapPin className="w-5 h-5" />
                    </div>
                    <div>
                      <span className="text-xs uppercase font-bold text-[#6C7099] block">Office Address</span>
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <span className="text-xs uppercase font-bold text-[#6C7099] block">Phone Line</span>
                      <a href={`tel:${siteConfig.contact.phoneRaw}`} className="font-bold text-base hover:text-[#2151F5] transition-colors">
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <span className="text-xs uppercase font-bold text-[#6C7099] block">WhatsApp Business</span>
                      <a href={siteConfig.contact.whatsappLink} target="_blank" rel="noopener noreferrer" className="font-bold text-base text-[#2151F5] hover:underline flex items-center gap-1">
                        <span>{siteConfig.contact.whatsapp}</span>
                        <span className="text-xs px-2 py-0.5 rounded-md bg-[#2151F5] text-white">Chat Now</span>
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <span className="text-xs uppercase font-bold text-[#6C7099] block">Email Address</span>
                      <a href={`mailto:${siteConfig.contact.email}`} className="font-semibold text-base hover:text-[#2151F5] transition-colors">
                  ...
                  {/* Hours */}
                  <div className="flex items-start gap-3.5 pt-3 border-t border-[#E3E6F7]">
                    <div className="w-10 h-10 rounded-xl bg-[#FDEAF7] text-[#10122B] flex items-center justify-center shrink-0">
                      <Clock className="w-5 h-5" />
                    </div>
                    <div>
                      <span className="text-xs uppercase font-bold text-[#6C7099] block">Working Hours</span>
                      <span className="font-medium text-xs text-[#4B4F72]">{siteConfig.contact.hours}</span>
                    </div>
                  </div>
            ...
            <div className="lg:col-span-7">
              <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#E3E6F7] shadow-soft-lg">
                <h3 className="font-display text-2xl font-bold text-[#10122B] mb-6">
                ...
                {status === "success" ? (
                  <div className="py-12 text-center space-y-4">
                    ...
                    <h4 className="font-display text-2xl font-bold text-[#10122B]">
                      Message Received!
                    </h4>
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 rounded-full bg-gradient-to-r from-[#2151F5] to-[#7B3FF2] text-white text-sm font-bold hover:shadow-md hover:shadow-[#E5389E]/20 transition-all"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <select
                            ...
                            onChange={handleChange}
                            className="px-2.5 py-3 rounded-xl border border-[#E3E6F7] bg-[#F6F7FF] text-[#10122B] text-sm font-medium shrink-0 focus:outline-none focus:ring-2 focus:ring-[#2151F5]"
                          >
                      ...
                      <div>
                        <label htmlFor="email" className="block text-xs font-semibold text-[#10122B] uppercase tracking-wider mb-2">
                          Email Address <span className="text-[#2151F5]">*</span>
                        </label>
                        <input
                          type="email"
                          id="email"
                    ...
                    {/* Message */}
                    <div>
                      <label htmlFor="message" className="block text-xs font-semibold text-[#10122B] uppercase tracking-wider mb-2">
                    ...
                    <button
                      ...
                      className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-[#2151F5] via-[#5A3FE0] to-[#E5389E] bg-[length:180%_100%] bg-left text-white font-bold text-base shadow-md hover:bg-right hover:shadow-lg hover:shadow-[#E5389E]/25 transition-all duration-500 flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {status === "submitting" ? (
                        <>
      ...
      <section className="py-12 bg-[#F6F7FF] border-t border-[#E3E6F7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl overflow-hidden border border-[#E3E6F7] shadow-soft h-[400px] relative">
            <iframe
