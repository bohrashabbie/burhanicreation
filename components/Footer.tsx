...
export default function Footer() {
  return (
    <footer className="relative bg-[#10122B] text-white pt-16 pb-12 border-t border-[#10122B] overflow-hidden">
      {/* Decorative brand-gradient top hairline */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#7B3FF2] to-transparent" />

      {/* Ambient mesh blobs for depth */}
      <div className="absolute -top-32 -left-20 w-[420px] h-[420px] bg-[#2151F5]/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -right-20 w-[420px] h-[420px] bg-[#E5389E]/15 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="inline-flex items-center gap-3 group">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#2151F5] via-[#7B3FF2] to-[#E5389E] flex items-center justify-center text-white font-bold text-xl shadow-md shadow-[#E5389E]/20">
                <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                </svg>
              </div>
              <div className="flex flex-col">
                <span className="font-display text-xl font-extrabold tracking-tight text-white group-hover:text-[#D6E4FF] transition-colors">
                  Burhani Creation
                </span>
                <span className="text-[10px] uppercase tracking-widest font-semibold text-[#E5389E]">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-white hover:bg-gradient-to-br hover:from-[#2151F5] hover:to-[#E5389E] hover:border-transparent transition-all"
              >
          ...
          <div className="space-y-4">
            <h4 className="text-xs uppercase tracking-widest font-bold text-[#2151F5]">
              Navigation
            </h4>
